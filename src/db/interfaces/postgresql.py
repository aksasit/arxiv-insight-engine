...
class PostgreSQLDatabase(BaseDatabase):
    ...
    def startup(self) -> None:
        ...
        try:
            ...
            self.engine = create_engine(
                ...
                pool_pre_ping=True # Verify connection before ping               
            )
            ...
            updated_tables = inspect(self.engine)
            ...
            logger.info("PostgreSQL database intialized successfully.")     
            ...
            logger.error(f"Failed to intialize PostgreSQL database: {e}")
            raise
    ...
    def get_session(self) -> Generator[Session, None, None]:
        ...
        if not self.session_factory:
            raise RuntimeError("Database not intialized. Call startup() first.")
